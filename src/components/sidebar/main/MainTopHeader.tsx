...
export const MainTopHeader = () => {
    ...
    return (
        <header className="top-0 w-full z-50 bg-white text-black dark:bg-[rgb(0,0,0)] dark:text-white border-b border-black/10 dark:border-white/10 transition-colors duration-300">
            {/* ✅ 중앙 정렬 컨테이너 */}
